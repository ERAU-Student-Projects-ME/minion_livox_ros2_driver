...
user_config_path = os.path.join(cur_config_path, 'junior_livox_lidar.json')
deskew_config_path = os.path.join(cur_config_path, 'deskew.yaml')
...
def generate_launch_description():
    ...
    deskew_node = Node(
        ...
        name='lidar_deskew_node',
        output='screen',
        prefix=['taskset -c 15,16'],
        parameters=[deskew_config_path]
    )
    launch_entities.append(deskew_node)
